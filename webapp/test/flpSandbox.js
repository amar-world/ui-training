		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Manage User",
									"targetURL": "#demotrainingui5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"demotrainingui5-display": {
								"semanticObject": "demotrainingui5",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=demo.trainingui5",
									"url": sap.ui.require.toUrl("demo/trainingui5")
								}
							}
						}
					}
